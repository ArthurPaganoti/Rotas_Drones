...
from GrafoVisual import GrafoVisual

# Input para a autonomia do drone
autonomia_maxima = int(input("Digite a autonomia do drone em metros: "))
...
grafo_visual = GrafoVisual(grafo_dados)
grafo_visual.mostrar_grafo(caminho)